...
public class SetupUserPasswordRequestBean implements Serializable
{
     ...
     * @param emailId
     */
    public SetupUserPasswordRequestBean(String empId, String password, String tempPassword, String emailId)
    {
        super();
        this.empId = empId;
    ...
    {
        return "SetupUserPasswordRequestBean [empId=" + empId + ", password=" + password + ", tempPassword=" + tempPassword + ", emailId=" + emailId + "]";
    }
